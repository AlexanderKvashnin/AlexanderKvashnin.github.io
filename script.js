...
function simulateGoogleScholarFetch() {
    return new Promise((resolve) => {
        setTimeout(() => {
            resolve([
                { title: "Boosting the Performance of Pt/C Catalysts via Nitrogen-Doped Carbon Support: Insights from Structural and Electrochemical Characterization", authors: "Yu.A. Bayan, E.R. Beskopylny, E.U. Gerasimov, E.E. Aydakov, K.K. Volik, I.V. Pankov, I.V. Chepkasov, M.M. Lukanov, A.G. Kvashnin, A.A. Alekseenko", journal: "Small", year: "2025", url: "/assets/pdfs/2025_Small.pdf" },
                { title: "Vacuum-free arc synthesis and characterization of crystalline molybdenum borides as instrumental material", authors: "Yu. Vassilyeva, Yu. Neklya, M. Lukanov, A. Kvashnin, A. Pak", journal: "Thermal Science and Engineering Progress", year: "2025", url: "/assets/pdfs/2025_vacuum_free_arc.pdf" },
                ...
                { title: "Discovery of chemically modified higher tungsten boride by means of hybrid GNN/DFT approach", authors: "N.A. Matsokin, R.A. Eremin, A.A. Kuznetsova, I.S. Humonen, A.V. Krautsou, V.D. Lazarev, Y.Z. Vassilyeva, A.Ya. Pak, S.A. Budennyy, A.G. Kvashnin, A.A. Osiptsov", journal: "npj Computational Materials", year: "2025", url: "/assets/pdfs/2025_discovery_of_chemically.pdf" },
                ...
                { title: "Synthesis of high-entropy Ti-Zr-Nb-Hf-Ta carbides and carbonitrides in high-speed arc discharge plasma jet", authors: "D.S. Nikitin, I.I. Shanenkov, A.R. Nassyrbayev, A.A. Sivkov, V.S. Baidyshev, Yu.A. Kvashnina, N.A. Matsokin, A.Ya. Pak, A.G. Kvashnin", journal: "Journal of Alloys and Compounds", year: "2025", url: "#" },
                { title: "Physically intuitive anisotropic model of hardness", authors: "F.N. Jalolov and A.G. Kvashnin", journal: "Physical Review Materials", year: "2024", url: "#" },
                { title: "Melting simulations of high-entropy carbonitrides by deep learning potentials", authors: "V.S. Baidyshev, C. Tantardini, A.G. Kvashnin", journal: "Scientific Reports", year: "2024", url: "#" },
                { title: "Material hardness descriptor derived by symbolic regression", authors: "C. Tantardini, H.A. Zakaryan, Z.-K. Han, T. Altalhi, S.V. Levchenko, A.G. Kvashnin, B.I. Yakobson", journal: "Journal of Computational Science", year: "2024", url: "#" },
                ...
                { title: "Theoretical study of adsorption properties and CO oxidation reaction on surfaces of higher tungsten boride", authors: "A.D. Radina, V.S. Baidyshev, I.V. Chepkasov, N.A. Matsokin, T. Altalhi, B.I. Yakobson, A.G. Kvashnin", journal: "Scientific Reports", year: "2024", url: "#" },
                ...
                { title: "Photocatalytic H2 generation and CO2 reduction by WB5-x cocatalyst of TiO2 catalyst", authors: "A.Yu. Kurenkova, A.D. Radina, V.S. Baidyshev, P.V. Povalyaev, E.E. Aidakov, E.Yu. Gerasimov, D.D. Mishchenko, A.V. Zhurenok, A.Ya. Pak, E.A. Kozlova, A.G. Kvashnin", journal: "Applied Surface Science", year: "2024", url: "#" },
                { title: "Mechanical Properties of Single and Polycrystalline Solids from Machine Learning", authors: "F.N. Jalolov, E.V. Podryabinkin, A.R. Oganov, A.V. Shapeev, A.G. Kvashnin", journal: "Advanced Theory and Simulations", year: "2024", url: "#" },
                { title: "Structure-driven tuning of catalytic properties of core–shell nanostructures", authors: "I.V. Chepkasov, A.D. Radina, A.G. Kvashnin", journal: "Nanoscale", year: "2024", url: "#" },
                { title: "Origin of brittle behavior of doped PbTe-based thermoelectric materials", authors: "I.V. Chepkasov, A.G. Kvashnin, A.D. Radina, N.A. Matsokin, F.N. Jalolov, D.G. Kvashnin, A.R. Oganov, Z. Dashevsky", journal: "Applied Physics Letters", year: "2024", url: "#" },
                { title: "Synthesis and Characterization of Niobium Carbide Thin Films on Diamond Surface for Superconductive Application", authors: "R.A. Khmelnitsky, V.P. Martovitsky, J.V. Bondareva, A.I. Kolbatova, N. Titova, G.N. Goltsman, F.S. Fedorov, A.V. Egorov, N.A. Matsokin, A.G. Kvashnin, D.G. Kvashnin, S.A. Evlashin", journal: "Journal of Alloys and Compounds", year: "2024", url: "#" },
                { title: "Generating and grading 34 optimised norm-conserving Vanderbilt pseudopotentials for actinides and super-heavy elements in the PseudoDojo", authors: "С. Tantardini, M. Iliaš, M. Giantomassi, A.G. Kvashnin, V. Pershina, X. Gonze", journal: "Computer Physics Communications", year: "2024", url: "#" },
                { title: "Tuning the surface properties of AuPd nanoparticles for adsorption of O and CO", authors: "I.V. Chepkasov, I.S. Zamulin, V.S. Baidyshev, A.G. Kvashnin", journal: "Physical Chemistry Chemical Physics", year: "2023", url: "#" },
                { title: "Structure-driven tuning of O and CO adsorption on AuCu nanoparticles. A DFT Study", authors: "I.V. Chepkasov, V.S. Baidyshev, A.G. Kvashnin", journal: "Physical Review B", year: "2023", url: "#" },
                ...
                { title: "Ultra-Low Thermal Conductivity of Moiré Diamanes", authors: "S. Chowdhury, V.A. Demin, L.A. Chernozatonskii, A.G. Kvashnin", journal: "Membranes", year: "2022", url: "#" },
                { title: "Cu–Au nanoparticles produced by the aggregation of gas-phase metal atoms for CO oxidation", authors: "I.V. Chepkasov, V.S. Baidyshev, A.A. Golubnichiy, I.S. Zamulin, A.G. Kvashnin, S.M. Kozlov", journal: "Aggregate", year: "2022", url: "#" },
                { title: "Effect of magnetic impurities on superconductivity in LaH10", authors: "D.V. Semenok, I.A. Troyan, A.V. Sadakov, D. Zhou, M. Galasso, A.G. Kvashnin, I.A. Kruglov, A.A. Bykov, K.Y. Terent'ev, A.V. Cherepahin, O.A. Sobolevskiy, K.S. Pervakov, A.Yu. Seregin, T. Helm, T. Förster, A.D. Grockowiak, S.W. Tozer, Y. Nakamoto, K. Shimizu, V.M. Pudalov, I.S. Lyubutin, A.R. Oganov", journal: "Advanced Materials", year: "2022", url: "#" },
                { title: "Large-Scale Synthesis and Applications of Hafnium–Tantalum Carbides", authors: "A.G. Kvashnin, D.S. Nikitin, I.I. Shanenkov, I.V. Chepkasov, Yu.A. Kvashnina, A. Nassyrbayev, A.A. Sivkov, Z. Bolatova, A.Ya. Pak", journal: "Advanced Functional Materials", year: "2022", url: "#" },
                { title: "Crystal Structure Evolution of Fluorine Under High Pressure", authors: "C. Tantardini, F.N. Jalolov, A.G. Kvashnin", journal: "Journal of Physical Chemistry C", year: "2022", url: "#" },
                { title: "Sr-Doped Molecular Hydrogen: Synthesis and Properties of SrH22", authors: "D.V. Semenok, W. Chen, X. Huang, D. Zhou, I.A. Kruglov, A.B. Mazitov, M. Galasso, C. Tantardini, X. Gonze, A.G. Kvashnin, A.R. Oganov, T. Cui", journal: "Advanced Materials", year: "2022", url: "#" },
                { title: "High-temperature superconductivity in hydrides", authors: "I.A. Trojan, D.V. Semenok, A.G. Ivanova, A.G. Kvashnin, D. Zhou, A.V. Sadakov, O.A. Sobolevsky, V.M. Pudalov, I.S. Lyubutin, A.R. Oganov", journal: "Physics-Uspekhi", year: "2022", url: "#" },
                { title: "Efficient Synthesis of WB5-x-WB2 Powders with Selectivity for WB5-x Content", authors: "A.Ya. Pak, D.V. Rybkovskiy, Yu.Z. Vassilyeva, E.N. Kolobova, A.V. Filimonenko, A.G. Kvashnin", journal: "Inorganic Chemistry", year: "2022", url: "#" },
                { title: "Computational Design of Gas Sensors Based on V3S4 Monolayer", authors: "I.V. Chepkasov, E.V. Sukhanova, A.G. Kvashnin, H.A. Zakaryan, M.A. Aghamalyan, Y.Sh. Mamasakhlisov, A.M. Manakhov, Z.I. Popov, D.G. Kvashnin", journal: "Nanomaterials", year: "2022", url: "#" },
                { title: "2D-Mo3S4 phase as promising contact for MoS2", authors: "E.V. Sukhanova, A.G. Kvashnin, L.A. Bereznikova, H.A. Zakaryan, M.A. Aghamalyan, D.G. Kvashnin, Z.I. Popov", journal: "Applied Surface Science", year: "2022", url: "#" },
                { title: "Map of Two-Dimensional Tungsten Chalcogenide Compounds (W–S, W–Se, W–Te) Based on USPEX Evolutionary Search", authors: "E.V. Sukhanova, A.G. Kvashnin, M.A. Agamalyan, H.A. Zakaryan, Z.I. Popov", journal: "JETP Letters", year: "2022", url: "#" },
                { title: "Nanohardness from First Principles with Active Learning on Atomic Environments", authors: "E.V. Podryabinkin, A.G. Kvashnin, M. Asgarpour, I.I. Maslenikov, D.A. Ovsyannikov, P.B. Sorokin, M.Yu Popov, A.V. Shapeev", journal: "Journal of Chemical Theory and Computation", year: "2022", url: "#" },
                { title: "Diamane quasicrystals", authors: "L.A. Chernozatonskii, V.A. Demin, A.G. Kvashnin, D.G. Kvashnin", journal: "Applied Surface Science", year: "2022", url: "#" }
            ]);
        }, 1000);
    });
}
